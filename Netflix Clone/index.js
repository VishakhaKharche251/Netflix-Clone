...
const apiPaths = {
    fetchAllCategories: `${base_url}/genre/movie/list?api_key=${apikey}`,
    fetchMoviesList: (id) => `${base_url}/discover/movie?api_key=${apikey}&with_genres=${id}`,
    fetchTrending:`${base_url}/trending/all/day?api_key=${apikey}&language=en-US`,
